...
use crate::{font::UniqueId, instance::NormalizedCoord, scale::Hinting};
...
impl Cache {
    ...
    fn find_font(&mut self, font_id: Option<UniqueId>) -> (bool, usize) {
